 ...
 */
 ...
 const { printTitle,printBoldText,printBoxedText} = require('./formatter')
...
function promptUser(_config){
  printTitle('MemExplorer',"#FFFF00") //display title
  printBoldText('\t---- Your friendly Neighborhood Pending Transaction Explorer ----\n',"#008000") //display sub title
